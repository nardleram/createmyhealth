...
class SurveyRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'other_healthcare_services' => 'nullable|string|max:1',
            'other_healthcare_services_requested' => 'nullable|string|max:500',
            ...
            'other_educational_services' => 'nullable|string|max:1',
            'other_educational_services_requested' => 'nullable|string|max:500',
