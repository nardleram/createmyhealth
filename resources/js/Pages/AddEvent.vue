        ...
        <div class="w-4/6 sm:1/2 mx-auto py-10 px-5 md:px-0">
            ...
            <form @submit.prevent="submitEvent()">
                ...
                <div class="w-full mb-8 h-14">
                    ...
                    <input id="image" name="image" type="file" class="w-full text-slate-500 text-sm tracking-tight font-medium bg-lmhlBgInput shadow-sm rounded-lg focus:outline-1 focus:outline-lmhlMain1 border border-slate-400 focus:shadow-md file:bg-transparent file:border-0 file:bg-slate-700 file:mr-4 file:py-4 file:px-4 file:text-slate-300" required>
                </div>
