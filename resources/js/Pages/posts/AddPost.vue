        ...
        <div v-if="showUploadImageModal" class="fixed top-[30%] left-1/4 p-6 min-w-[615px] max-w-[650px] bg-white text-slate-600 w-1/2 rounded-lg shadow-md z-50 origin-center animate-open-bio">
            <form @submit.prevent="addImage()">
                ...
                <div class="w-full">
                    ...
                    <input multiple id="postImage" type="file" class="w-full text-slate-500 text-sm tracking-tight font-medium bg-lmhlBgInput shadow-sm rounded-lg focus:outline-1 focus:outline-lmhlMain1 border border-slate-400 focus:shadow-md file:border-0 file:bg-slate-600 file:mr-4 file:py-4 file:px-4 file:text-slate-300 file:cursor-pointer">
                </div>
