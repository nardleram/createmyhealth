...
<div class="mb-16 mt-24">
    ...
    <div class="top-0 left-0 w-full h-full hidden profile-popup-bg z-40 bg-black opacity-95 origin-center animate-open-bio-bg">
        ...
        <x-director-profile-bio class="emily">
            ...
            <x-slot:bio>
                <p class="px-6 py-3 leading-loose">I have worked in the voluntary and community sector for most of my life in many different roles, working with communities to develop and run a myriad of projects. I retrained in 2019 as a complementary therapist after starting my own business making natural wellbeing products of which I am totally hooked on! I’m really pleased to be a part of the Leeds Create My Health group and support the work of the People’s Health Alliance.</p>
            </x-slot>
        </x-director-profile-bio>
        ...
        <x-director-profile-bio class="anaïs">
            ...
            <x-slot:bio>
                <p class="px-6 py-3 leading-loose">My BA is in Philosophy, Psychology and History of Science from the University of Leeds. By day I have a full-time IT job, and pursue my other passions in my spare time: homeopathy at The School of Health, and  martial arts. I love long walks in our local woods and nature reserves, and hiking through the Dales or Peak District with my wolfdog. <br>I am grateful to have this opportunity of supporting Create My Health CIC and the People’s Health Alliance with my IT skills and deep interest in all matters pertaining to health.</p>
            </x-slot>
        </x-director-profile-bio>
    </div>
